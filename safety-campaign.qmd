...
```{=html}
<div class="tile-grid">
  <a class="tile" href="#about-the-campaign" style="--tile-color: var(--ios-blue);">
    <span class="tile-icon">ℹ️</span>
    <span><span class="tile-title">Overview</span><br><span class="tile-subtitle">Mission and overview</span></span>
  </a>
  <a class="tile" href="#endorsements" style="--tile-color: var(--ios-green);">
    <span class="tile-icon">👥</span>
    <span><span class="tile-title">Endorsements</span><br><span class="tile-subtitle">Societies and collaborators</span></span>
  </a>
  <a class="tile" href="#deliverables" style="--tile-color: var(--ios-orange);">
    <span class="tile-icon">✅</span>
    <span><span class="tile-title">Deliverables</span><br><span class="tile-subtitle">Educational resources</span></span>
  </a>
  <a class="tile" href="#global-outreach" style="--tile-color: var(--ios-purple);">
    <span class="tile-icon">🌍</span>
    <span><span class="tile-title">Global Outreach</span><br><span class="tile-subtitle">International participation</span></span>
  </a>
  <a class="tile" href="#join-the-campaign" style="--tile-color: var(--ios-cyan);">
    <span class="tile-icon">➕</span>
    <span><span class="tile-title">Join Campaign</span><br><span class="tile-subtitle">Become involved</span></span>
  </a>
</div>
```
...
::: {.callout-note}
**Source:** Lele AV, Sawant P, Blacker SN. **External ventricular drain safety campaign and opportunities for global neuroanesthesiology quality and safety.** *Current Opinion in Anaesthesiology.* 2026 Jul 13. [PMID: 42438063](https://pubmed.ncbi.nlm.nih.gov/42438063/)
:::
